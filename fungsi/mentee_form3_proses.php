...
if(empty($jawaban1) or empty($jawaban2) or empty($jawaban3) or empty($jawaban4) or empty($jawaban5) or empty($jawaban6) or empty($jawaban7) or empty($jawaban8) or empty($jawaban9) or empty($jawaban10) or empty($jawaban11) or empty($jawaban12) or empty($jawaban13) or empty($jawaban14) or empty($jawaban15) or empty($jawaban16)){
	...
	header("location:../mentee_form3.php?pesan=error1");
	die;
}


$sql = "INSERT INTO data_form_mentee (username, nomor_form, jawaban1, jawaban2, jawaban3, jawaban4, jawaban5, jawaban6, jawaban7, jawaban8, jawaban9, jawaban10, jawaban11, jawaban12, jawaban13, jawaban14, jawaban15, jawaban16) 
		VALUES ('$username', '3', '$jawaban1', '$jawaban2', '$jawaban3', '$jawaban4', '$jawaban5', '$jawaban6', '$jawaban7', '$jawaban8', '$jawaban9', '$jawaban10', '$jawaban11', '$jawaban12', '$jawaban13', '$jawaban14', '$jawaban15', '$jawaban16')";
$query = mysqli_query($conn, $sql);

$sql2 = "INSERT INTO history_mentee (nomor_form, judul_form, status, tanggal, username) 
		VALUES ('3', 'Kuesioner Mentee', 'selesai', '$tanggal', '$username')";
