		  ...
		  <!-- valdasi username, password -->
			...
			if(isset($_GET['username'])){
				if($_GET['username'] == "kosong"){
					echo "<center><h5 style='color:red'>Username belum dimasukkan</h5></center><br>";
				}
			}
			if(isset($_GET['password'])){
				if($_GET['password'] == "kosong"){
					echo "<center><h5 style='color:red'>Password belum dimasukkan</h5></center><br>";
				}
			}
			if(isset($_GET['usernamepassword'])){
				if($_GET['usernamepassword'] == "salah"){
					echo "<center><h5 style='color:red'>Username atau password salah</h5></center><br>";
				}
			}
			?>
